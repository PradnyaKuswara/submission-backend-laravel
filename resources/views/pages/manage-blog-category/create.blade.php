...
@section('content')
    ...
    <div class="max-w-screen-xl mx-auto pt-28 pb-52 p-5" x-data="createBlogCategoryPage">
        <div>
            <h1 class="sans text-xl text-extrabold animate__animated animate__fadeInDown">Create Blog Category</h1>
        </div>
        ...
        <div class="mt-4 relative overflow-x-auto shadow-lg sm:rounded-lg animate__animated animate__fadeIn">
            <form @submit.prevent="createCategory()">
                ...
                <div class="my-4">
                    <button type="submit"
                        class="bg-teal-900 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">Create
                        Category</button>
                </div>
            </form>
        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('createBlogCategoryPage', () => ({
                formData: {
                    name: '',
                },
